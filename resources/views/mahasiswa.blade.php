            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    ...
                    <form id="delete-form-{{$mhs->id_mahasiswa}}" action="{{ route('delete', $mhs->id_mahasiswa) }}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button type="submit" class="btn btn-danger" onclick="return confirm('apakah yakin dek?')">Hapus</button>
                  </form>
                </td>
              </tr>
              @endforeach
